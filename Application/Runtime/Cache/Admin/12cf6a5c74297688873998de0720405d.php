...
<table cellpadding="3" cellspacing="1">
  <tr>
    <th>
      ...
      <a href="#">编号</a><img src="/Application/Admin/Public/images/sort_desc.gif"/>    </th>
  ...
  <tr>
    ...
    <td align="right"><span ><?php echo $v['goods_price']?>
    </span></td>
    <td align="center"><img src="/Application/Admin/Public/images/<?php echo $v['is_sale']==1?'yes':'no'?>.gif"  /></td>
    <td align="center"><img src="/Application/Admin/Public/images/<?php echo $v['is_dest']==1?'yes':'no'?>.gif"  /></td>
    <td align="center"><img src="/Application/Admin/Public/images/<?php echo $v['is_new']==1?'yes':'no'?>.gif"  /></td>
    <td align="center"><img src="/Application/Admin/Public/images/<?php echo $v['is_hot']==1?'yes':'no'?>.gif"  /></td>

    <td align="center"><span ><?php echo $v['goods_desc']?></span></td>
        <td align="right"><span ><?php echo $v['goods_number']?></span></td>
        <td align="center">
      <a href="#" target="_blank" title="查看"><img src="/Application/Admin/Public/images/icon_view.gif" width="16" height="16" border="0" /></a>
      <a href="<?php echo U('update')?>" title="编辑"><img src="/Application/Admin/Public/images/icon_edit.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="复制"><img src="/Application/Admin/Public/images/icon_copy.gif" width="16" height="16" border="0" /></a>
      <a href="<?php echo U('delete')?>"  title="回收站"><img src="/Application/Admin/Public/images/icon_trash.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="货品列表"><img src="/Application/Admin/Public/images/icon_docs.gif" width="16" height="16" border="0" /></a>          </td>
  </tr>
  <?php endforeach ?>
      </table>
