...
<script type="text/javascript" src="/Application/Admin/Public/js/transport.js"></script><script type="text/javascript" src="js/common.js"></script><script language="JavaScript">
<!--
// 这里把JS用到的所有语言都赋值到这里
...
<h1>
<span class="action-span"><a href="/index.php/Admin/Attrtype/attrtypeAdd">添加分类</a></span>
...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php foreach($list as $val):?>
    ...
    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255); padding-left:<?php echo $rows['deep']*30?>px">
            <img src="/Public/Admin/images/menu_minus.gif">
            <span><?php echo $val['type_name']?></span>
        </td>
    <td width="10%" align="right" style="background-color: rgb(255, 255, 255);"><?php echo $rows['sort']?></td>
    <td width="24%" align="center" style="background-color: rgb(255, 255, 255);"><a href="/index.php/Admin/attr/list/type_id/<?php echo $val['type_id']?>">属性列表</a> |<a href="/index.php/Admin/Attrtype/attrtypeEdit/type_id/<?php echo $val[type_id]?>">编辑</a> |
      <a href="/index.php/Admin/Attrtype/attrtypeDelete/type_id/<?php echo $val[type_id]?>" onClick="return confirm('确定要删除吗？')" title="移除">移除</a>
    </td>
  </tr>
<?php endforeach ?>
  </tbody></table>
...
<div id="footer">
共执行 1 个查询，用时 0.003771 秒，Gzip 已禁用，内存占用 2.209 MB<br>
