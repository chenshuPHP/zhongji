...
<h1>
<span class="action-span"><a href="/index.php/Admin/Category/categoryAdd">添加分类</a></span>
...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php foreach($list as $val):?>
    ...
    <td width="24%" align="center" style="background-color: rgb(255, 255, 255);"><a href="/index.php/Admin/attr/list/type_id/<?php echo $val['type_id']?>">属性列表</a> |<a href="/index.php/Admin/Category/categoryEdit/type_id/<?php echo $val[type_id]?>">编辑</a> |
      <a href="/index.php/Admin/Category/categoryDelete/type_id/<?php echo $val[type_id]?>" onClick="return confirm('确定要删除吗？')" title="移除">移除</a>
    </td>
  </tr>
<?php endforeach ?>
  </tbody></table>
