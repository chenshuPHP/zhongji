...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php foreach($auth_list as $rows){?>
  <tr align="center" class="0" id="0_1" id = 'tr_1'>
    <td align="left" class="first-cell" style = 'padding-left="0"'>
          <?php echo str_repeat('&nbsp;',$rows['deel']*4).$rows['auth_name']?> <img src="/Public/Admin/images/menu_minus.gif" id="icon_0_1" width="9" height="9" border="0" style="margin-left:0em" />

            <span><a href="#" ><?php  echo $v['priv_name']?></a></span>
        </td>
    <td width="10%"><?php echo $rows['model_name']?></td>
    <td width="10%"><?php echo $rows['controller_name']?></td>
    <td width="10%"><?php echo $rows['action_name']?></td>
    <td width="24%" align="center">
      <a href="<?php echo U('edit')?>">编辑</a> |
      <a href="<?php echo U('lst')?>" title="移除">移除</a>
    </td>
  </tr>
<?php }?>    
  </table>
