...
<h1>
<span class="action-span"><a href="<?php echo U('add')?>">添加商品栏目</a></span>
<span class="action-span1"><a href="#">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 商品栏目列表 </span>
...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <tr align="center" class="0" id="0_1" id = 'tr_1'>
    <td align="left" class="first-cell" style = 'padding-left="0"'>
            <?php echo str_repeat('&nbsp;',$rows['deel']*5)?>
    ...
    <td width="24%" align="center">
      <a href="<?php echo U('Attribute/lst',array('type_id'=>$rows['cat_id']))?>">属性列表</a> |
      <a href="<?php echo U('update',array('cat_id'=>$rows['cat_id']))?>">修改</a> |
      <a href="<?php echo U('delete',array('cat_id'=>$rows['cat_id']))?>" title="移除">删除</a>
    </td>
  </tr>
<?php }?>    
  </table>
