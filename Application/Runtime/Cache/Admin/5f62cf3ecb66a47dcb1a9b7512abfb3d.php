        ...
        <ul id="menu-ul">
            ...
            商品管理
                <ul>
                    ...
                    <li class="menu-item"><a href="/index.php/Admin/Goods/goodsAdd" target="main-frame">添加新商品</a></li>
                    <li class="menu-item"><a href="/index.php/Admin/attrtype/attrtypeList" target="main-frame">属性分类</a></li>
                    <li class="menu-item"><a href="/index.php/Admin/Attribute/attrList" target="main-frame">商品属性</a></li>
                    <li class="menu-item"><a href="/index.php/Admin/Brand/BrandList" target="main-frame">商品品牌</a></li>
